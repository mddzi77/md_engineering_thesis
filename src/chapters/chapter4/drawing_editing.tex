...
którym jest \texttt{BoxCollider} z zaznaczoną opcją \textit{Is Trigger}.%, przedstawioną na listingu~\ref{lst:drag_update}.
Istotne jest także,
...
Służyła do tego funkcja \texttt{DrawInterpolate}.%, przedstawiona na listingu~\ref{lst:draw_interpolate}.
...
Podobnie jak w przypadku usuwania obszarowego, \textt{BoxCollider} musi być większy,
