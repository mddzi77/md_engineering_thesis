...
%Aby uporządkować\linebreak w hierarchii w edytorze wszystkie tworzone w puli obiekty,
...
\indent Do definiowania warstw stworzono \texttt{ScriptableObject}, \texttt{LayerConfig}.\linebreak
