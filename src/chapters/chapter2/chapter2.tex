...
Analiza ich zalet, ograniczeń, jak również przystępności dla użytkowników pozwala określić,\linebreak
...
co pozwoli na zrozumienie,\linebreak
jak powinien być zaprojektowany schludny i intuicyjny interfejs użytkownika.

\input{chapters/chapter2/magic}
\input{chapters/chapter2/microwind}
\input{chapters/chapter2/electric}
\input{chapters/chapter2/others}
